...
??? info "Registry for ITS Identifiers (RITSI)"
    [Registry for ITS Identifiers (RITSI)](https://isotc204.org/iso5345/): This registry records assigned values used for various identifier types (e.g., the ITS application identifier (ITS-AID)). The listing of ITS-AID values is identical to and is coordinated with the [listing of Provider Service Identifiers (PSIDs)](https://standards.ieee.org/products-programs/regauth/psid/public/) as managed by IEEE.
