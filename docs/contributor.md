...
_Comments_ and _Contributions_ concerning TC204 documents can only be provided via participating ISO members (National Standards Bodies (NSB)) through formal processes defined by ISO. _Comments_ can be provided directly to the respective NSB. The formal _ISO Standards_ process to _Contribute_ to TC204 documents is shown in Figure 1.  

![Figure 1. ISO Standards Process](https://www.iso.org/files/live/sites/isoorg/files/developing_standards/get_involved/img/Illust-The%20process2.svg)
